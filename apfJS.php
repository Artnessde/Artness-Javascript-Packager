 ...
 */
	 ...
	 */
		...
		{
			file_put_contents( 'Logfiles/'.date('Y-m-d').'.delivery.log', date('Y-m-d') . " " . date('H:i:s') . " " . $this->packid . " " . $status . " " . $size . " " . $_SERVER['REMOTE_ADDR'] . " " . $_SERVER['HTTP_USER_AGENT'] . "\n", FILE_APPEND);
		}
	}
